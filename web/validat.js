...
function validate_name (f){
    ...
    for (var i = 0; i<f.elements.length; i++) {
        if (f.elements[i].value == "" && f.attributes.id.value!="bulk") {
            ...
            if (f.elements[i].style.backgroundColor == 'rgb(254, 176, 170)') {
                f.elements[i].style.backgroundColor = 'white';
                f.elements[i].style.border = '1px solid grey';
            }
            switch (f.elements[i].name) {
                case "surname":
                    if (checkName(f.elements[i])) {
                        return false;
                    }
                    break;
                case "name":
                    ...
                    break;
                case "birthday":
                    if (checkDate(f.elements[i])) {
                        return false;
                    }
                    break;
                case "passportNumber":
                    if (checkInt(f.elements[i])) {
                        return false;
                    }
                    break;
                case "passportSeries":
